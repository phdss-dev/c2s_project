...
RSpec.describe Parsers::PartnerBParser, type: :parser do
  let(:fixtures_dir) { Rails.root.join("spec/fixtures/files/emails/partner_b") }
  ...
  describe ".applicable?" do
    it "returns true when sender matches" do
      email = Mail.new(from: "contato@parceirob.com")
